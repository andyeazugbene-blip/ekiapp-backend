...
export function validateSubscriptionPlanConfigInput(input: unknown): SubscriptionPlanConfigInput {
  ...
  return {
    ...
    maxCoupons: raw.maxCoupons == null ? null : requireInteger(raw.maxCoupons, "maxCoupons"),
    maxBundles: raw.maxBundles == null ? null : requireInteger(raw.maxBundles, "maxBundles"),
    ...
    customerDatabase: typeof raw.customerDatabase === "boolean" ? raw.customerDatabase : false,
    repeatBuyerMarketing: typeof raw.repeatBuyerMarketing === "boolean" ? raw.repeatBuyerMarketing : false,
    professionalStorefront: typeof raw.professionalStorefront === "boolean" ? raw.professionalStorefront : false,
    orderManagement: typeof raw.orderManagement === "boolean" ? raw.orderManagement : true,
    storeLinkSharing: typeof raw.storeLinkSharing === "boolean" ? raw.storeLinkSharing : false,
